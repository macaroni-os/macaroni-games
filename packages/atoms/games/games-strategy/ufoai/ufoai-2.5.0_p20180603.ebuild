...
src_configure() {
	...
	append-cxxflags -Wno-expansion-to-defined -std=c++14
	#/usr/lib/gcc/x86_64-pc-linux-gnu/11.3.0/../../../../x86_64-pc-linux-gnu/bin/ld: release-linux-x86_64/uforadiant/tools/radiant/libs/gtkutil/cursor.cpp.o: undefined reference to symbol 'XWarpPointer'
