...
REPO_CACHE?=quay.io/geaaru/games-amd64-cache
export REPO_CACHE
...
VALIDATE_OPTIONS?=
ARCH?=amd64
REPO_NAME?=macaroni-games
REPO_DESC?=Macaroni OS Games Phoenix
REPO_URL?=https://dl.macaronios.org/repos/macaroni-games/
...
repository/macaroni-funtoo:
	git clone -b phoenix --single-branch https://github.com/macaroni-os/macaroni-funtoo $(ROOT_DIR)/repository/macaroni-funtoo

validate: repository repository/mark repository/macaroni-commons repository/macaroni-funtoo
